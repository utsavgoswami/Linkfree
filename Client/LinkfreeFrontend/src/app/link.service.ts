...
export class LinkService {
  ...
  private PATCH_DELETE_ENDPOINT: string = 'https://localhost:44344/api/v1/Links/';
  ...
  public deleteLink(linkId: string): Observable<any> {
    const fullEndpoint: string = this.PATCH_DELETE_ENDPOINT + linkId;

    return this.httpClient.delete(fullEndpoint);
  }

  public updateLink(updatedLink: Link): Observable<any> {
    const fullEndpoint: string = this.PATCH_DELETE_ENDPOINT + updatedLink.LinkId;
